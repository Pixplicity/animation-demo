...
public class ScoreButtonView extends FrameLayout implements View.OnClickListener {
    ...
    public ScoreButtonView(Context context) {
        super(context);
        init();
    }

    public ScoreButtonView(Context context, AttributeSet attrs) {
        super(context, attrs);
        init();
    }

    public ScoreButtonView(Context context, AttributeSet attrs, int defStyleAttr) {
        super(context, attrs, defStyleAttr);
        init();
    }

    @TargetApi(Build.VERSION_CODES.LOLLIPOP)
    public ScoreButtonView(Context context, AttributeSet attrs, int defStyleAttr, int defStyleRes) {
        super(context, attrs, defStyleAttr, defStyleRes);
        init();
    }

    private void init() {
        LayoutInflater.from(getContext()).inflate(R.layout.view_score_button, this, true);
    ...
    public void onClick(View v) {
        ivStar.setImageResource(R.drawable.circle);
